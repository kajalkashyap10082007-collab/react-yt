      ...
      function showquestions(showsub, showques, index) {
        ...
        name.className =
          "h-[40px] w-[200px] border-2 border-gray-300 mt-[20px] ml-[10px]";
        name.placeholder = "Name";

        let comment = document.createElement("textarea");
        comment.className =
          "h-[100px] w-[530px] border-2 border-gray-300 mt-[15px] ml-[10px]";
        comment.placeholder = "Comment";

        let submit2 = document.createElement("button");
        submit2.className =
          "h-[30px] w-[100px] bg-indigo-400 rounded-[4px] ml-[450px] mt-[10px]";
        ...
        submit2.addEventListener("click", () => {
          if (name.value.trim() !== "" && comment.value.trim() !== "") {
            ...
            responseBox.innerHTML = `<b>${name.value}<br></b> ${comment.value}`;
      ...
      search.addEventListener("input", function () {
        ...
        if (matched.length > 0) {
          ...
          notFound.className = "text-[15px] text-gray-600  text-center mt-[20px]";
